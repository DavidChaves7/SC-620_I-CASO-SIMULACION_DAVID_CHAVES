...
public class SpaceshipController : MonoBehaviour
{
    ...
    private void HandleFire()
    {
        ...
        if (Input.GetButtonUp("Fire1"))
        {
            ...
            SoundManager.Instance.PlaySFX(fireSoundFX);
        }
    }
    ...
    private IEnumerator DieCoroutine()
    {
        ...
        //Nuevo mio David Chaves
        SoundManager.Instance.PlaySFX(dieSoundFX);

        yield return new WaitForSeconds(spawnWaitTime);


        //Move to levelmanager as Reload() 10 pts
        LevelManager controller = FindObjectOfType<LevelManager>();
